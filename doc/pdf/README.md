...
Только в расширенной и максимальной лицензии.
...
Получить подписанную выписку ЕГРЮЛ. Метод может исполняться долго, для получения результата стоит увеличить время ожидание ответа
...
Доступно в базовой лицензии. Параметр today работает только для расширенной и максимальной.
...
Доступно в базовой лицензии. Параметр full работает только для расширенной и максимальной.
