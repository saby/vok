...
- `datetime_from(datetime)` - дата время начало периода. Используется только в связке с datetime_to. Формат ГГГГ-ММ-ДДTЧЧ:ММ:СС, где T заменяет пробел
- `datetime_to(datetime)` - дата время конца периода. Используется только в связке с datetime_from. Формат ГГГГ-ММ-ДДTЧЧ:ММ:СС, где T заменяет пробел
...
Функционал недоступен в базовой лицензии.
В расширенной лицензии можно подписаться на 30 контрагентов
В максимальной лицензии можно подписаться на 1000 контрагентов
