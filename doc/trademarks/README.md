...
Метод доступен только в расширенной и максимальной лицензии
...
- `is_active(bool)` - флаг активности товарного знака, по умолчанию отдаются все. 
...
```text
https://api.sbis.ru/vok/trademarks?inn=7712040126
```
...
```text
https://api.sbis.ru/vok/trademarks/image?inn=7712040126&image_id=100500
```
